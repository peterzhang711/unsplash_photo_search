...
export const fetchPhotos = (searchItem='office', startPage=1,totalPage=10) => {
	// console.log("1")
	...
	return function(dispatch) {
		...
		axios.get(`https://api.unsplash.com/search/photos?client_id=WlP4xJCNnxeEYuB6GlAANv4eoj2SYIhsdJXnW1RvRV0&page=${startPage}&per_page=${totalPage}&query=${searchItem}`)
		// console.log("4")
			.then(res => {
				// debugger
				console.log("res",res)
